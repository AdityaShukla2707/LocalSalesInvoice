...
{
    /// <inheritdoc />
    public partial class Sales_Invoice : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateCode = table.Column<string>(type: "char(3)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UIDNumber = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_EmailId_UIDNumber",
                table: "Users",
                columns: new[] { "EmailId", "UIDNumber" },
                unique: true);
